...
class Productchange extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'etsy_productchange';
    ...
    {
        $this->_init('Ced\Etsy\Model\ResourceModel\Productchange');
    }
    ...
    public function setProductChange($productId, $oldValue='', $newValue='', $type)
    {
        ...
        $profileProduct = $objectManager->create('Ced\Etsy\Model\Profileproducts')->loadByField('product_id', $productId);
